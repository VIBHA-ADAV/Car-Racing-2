...
function car1_up()
{
	...
	{
		carl_y = carl_y - 10;
		console.log("when up arrow is pressed, x = " + carl_x + " | y = " +carl_y);
		 uploadBackground();
		 uploadcar1();
		 uploadcar2();
	}	
...
function car1_down()
{
	...
	{
		carl_y = carl_y + 10;
		console.log("when down arrow is pressed, x = " + carl_x + " | y = " +carl_y);
		 uploadBackground();
		 uploadcar1();
		 uploadcar2();
	}	
...
function car1_left()
{
	...
	{
		carl_x = carl_x - 10;
		console.log("when left arrow is pressed, x = " + carl_x + " | y = " +carl_y);
		 uploadBackground();
		 uploadcar1();
		 uploadcar2();
	}	
...
function car1_right()
{
	...
	{
		carl_y = carl_y - 10;
		console.log("when right arrow is pressed, x = " + carl_x + " | y = " +carl_y);
		 uploadBackground();
		 uploadcar1();
		 uploadcar2();
	}	
